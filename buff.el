...
(defun ordered-switch-1()
  (interactive)
  (ordered-switch 0)
  )

(defun ordered-switch-2()
  (interactive)
  (ordered-switch 1)
  )
...
(defun ordered-switch-4()
  (interactive)
  (ordered-switch 3)
  )

(defun ordered-switch-5()
  (interactive)
  (ordered-switch 4)
  )

(defun ordered-switch-6()
  (interactive)
  (ordered-switch 5)
  )

(defun ordered-switch-7()
  (interactive)
  (ordered-switch 6)
  )

(defun ordered-switch-8()
  (interactive)
  (ordered-switch 7)
  )

(defun ordered-switch-9()
  (interactive)
  (ordered-switch 8)
  )

(defun ordered-switch-0()
  (interactive)
  (ordered-switch 9)
  )
